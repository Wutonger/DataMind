...
('ai.model.default', '{"provider":"openai","baseUrl":"https://api.openai.com/v1","apiKey":"","model":"gpt-4o","embeddingModel":"text-embedding-3-small","temperature":0.7,"reasoningEnabled":true,"reasoningEffort":"medium","maxContextTokens":128000}', 'Default AI model config');
